...
export class ConfirmPlacementClaimCedantSettlementBankDto {
  @ApiProperty({
    type: String,
    format: 'date-time',
  ...
  @ApiPropertyOptional({
    ...
    description:
      'Compatibility field for legacy settlements without an operational settlement method. Confirmation cannot change an existing operational method.',
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    maxLength: 3,
    description:
      'Compatibility field for legacy settlements without an operational settlement currency. Confirmation cannot change an existing operational currency.',
  })
  @TrimmedString()
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    ...
    minimum: 0.000001,
    description:
      'Confirmed transaction FX rate. Required when settlement currency differs from payable currency and no persisted agreed FX already exists.',
  })
  @Type(() => Number)
  @IsOptional()
