...
export function AddAgreementPanel({
  ...
  const {
    ...
    defaultValues: { type: '', title: '', details: '' },
  });
  ...
  return (
    <SidePanel
      ...
      onClose={handleClose}
      title="Add Agreement"
      description="Define a company agreement that employees will be required to sign."
      footer={
        <div className="flex justify-end gap-3">
          <Button variant="secondary" onClick={handleClose}>
            Cancel
          </Button>
          <Button isLoading={isSubmitting} loadingText="Creating…" onClick={handleSubmit(onSubmit)}>
            Create
          </Button>
        </div>
      }
    >
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ...
          rows={10}
          className={inputClass(errors.details?.message, 'resize-none')}
        />
