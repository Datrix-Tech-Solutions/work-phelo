...
// type Row =
//   | { status: 'complete'; cashAccount: AccountingCashAccount }
//   | { status: 'incomplete'; glAccount: GLAccount };
...
//     );
//     return [
//       ...cashAccounts.map((cashAccount): Row => ({ status: 'complete', cashAccount })),
//       ...incomplete.map((glAccount): Row => ({ status: 'incomplete', glAccount })),
//     ];
