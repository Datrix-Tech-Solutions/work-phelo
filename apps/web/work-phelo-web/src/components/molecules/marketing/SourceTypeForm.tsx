...
interface Props {
  values: SourceTypeFields;
  onChange: (values: SourceTypeFields) => void;
  errors?: Partial<SourceTypeFields>;
}

export function SourceTypeForm({ values, onChange, errors }: Props) {
  return (
