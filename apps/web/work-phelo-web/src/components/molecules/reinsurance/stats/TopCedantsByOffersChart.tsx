...
export function TopCedantsByOffersChart({ period }: TopCedantsByOffersChartProps) {
  ...
  return (
    <div className={cardClass('flex flex-col gap-2 p-6 h-72', 'glass')}>
      <h3 className="text-sm font-semibold text-gray-900">Top 5 Cedants by Offers</h3>
