  ...
  return (
    <span ref={wrapperRef} className="relative inline-flex">
      <button
        ...
        className={cn(
          'text-xs font-medium border hover:text-white hover:scale-[1.2] active:scale-[0.97] rounded px-3 py-1.5 transition-all disabled:opacity-50 disabled:cursor-wait disabled:hover:scale-100',
