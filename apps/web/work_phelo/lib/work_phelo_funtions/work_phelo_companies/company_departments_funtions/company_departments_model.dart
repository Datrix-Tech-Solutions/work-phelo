...
class CompanyDepartmentsModel {
  ...
  // ── copyWith ────────────────────────────────────────────────
  CompanyDepartmentsModel copyWith({
    String? name,
    String? tenantSlug,
    Color? color,
    IconData? icon,
    ...
    return CompanyDepartmentsModel(
      id: id,
      name: name ?? this.name,
  ...
  // ── Helpers ─────────────────────────────────────────────────
  CompanyDepartmentsModel addMember(String email) {
    if (memberEmails.contains(email)) return this;
    return copyWith(memberEmails: [...memberEmails, email]);
  }
 
  CompanyDepartmentsModel removeMember(String email) {
    return copyWith(
  ...
  CompanyDepartmentsModel setHead(String email) {
  ...
  CompanyDepartmentsModel clearHead() => copyWith(headEmail: null);
}
